...
| Type          | Description                                                                  |
| :------------ | :--------------------------------------------------------------------------- |
|uint256 | True if voter has up voted on ballot, false otherwise.
### hasDownVoted
```solidity
...
| Type          | Description                                                                  |
| :------------ | :--------------------------------------------------------------------------- |
|uint256 | True if voter has down voted on ballot, false otherwise.
### _voterUpWeight
```solidity
...
| Type          | Description                                                                  |
| :------------ | :--------------------------------------------------------------------------- |
|uint256 | The weighted value of the vote.
